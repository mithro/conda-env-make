...
$(CONDA_ENV_DIR): $(CONDA_PYTHON)
	$(IN_CONDA_ENV_BASE) conda config --system --add envs_dirs $(CONDA_ENV_DIR)
	$(MKDIR) "$(CONDA_ENV_DIR)"

$(CONDA_ENV_PYTHON): $(ENVIRONMENT_FILE) $(REQUIREMENTS_FILE) | $(CONDA_PYTHON) $(CONDA_ENVS_DIR) $(CONDA_PKGS_DEP)
